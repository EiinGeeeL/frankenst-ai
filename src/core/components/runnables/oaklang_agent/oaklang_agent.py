...
class OakLangAgent(RunnableBuilder):
    ...
    def _build_prompt(self) -> ChatPromptTemplate:
        ...
        # Prepare the prompt
        context = load_and_clean_text_file(resolve_path_from_module(__file__, 'prompt', 'context.txt'))
        instructions = load_and_clean_text_file(resolve_path_from_module(__file__, 'prompt', 'instructions.txt'))
        input = load_and_clean_text_file(resolve_path_from_module(__file__, 'prompt', 'input.txt'))
        output_format = load_and_clean_text_file(resolve_path_from_module(__file__, 'prompt', 'output_format.txt'))
        restrictions = load_and_clean_text_file(resolve_path_from_module(__file__, 'prompt', 'restrictions.txt'))
